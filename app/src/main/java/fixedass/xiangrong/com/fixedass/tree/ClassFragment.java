 ...
 * @Describe 部门树结构设计
 */
public class ClassFragment extends Fragment implements TreeNode.TreeNodeClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tView.setDefaultNodeClickListener(ClassFragment.this);
    ...
    public void onClick(TreeNode node, Object value) {
        if (value instanceof SocialViewHolder.SocialItem){
            ...
            Redirect.redirect(getActivity(), LedgerSelActivity.class, bundle);

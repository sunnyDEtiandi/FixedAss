...
public class TransferUpdUserActivity extends Activity{
    ...
    private void initView(){
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Redirect.redirect(TransferUpdUserActivity.this, TransferUpdActivity.class, bundle);
            }
        });
    ...
    private void loadPeople(){
        if (!Redirect.checkNetwork(TransferUpdUserActivity.this)) {
            Toast toast = Toast.makeText(TransferUpdUserActivity.this,"网络未连接", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else{
            // 提示框
            dialog = new ProgressDialog(TransferUpdUserActivity.this);
            dialog.setTitle("提示");
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Fragment f = Fragment.instantiate(TransferUpdUserActivity.this, fragmentClass.getName());

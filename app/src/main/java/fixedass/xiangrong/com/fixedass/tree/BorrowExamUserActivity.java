...
import fixedass.xiangrong.com.fixedass.manage.BorrowExamActivity;
...
public class BorrowExamUserActivity extends Activity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_borrow_peo);
    ...
    private void initView(){
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Redirect.redirect(BorrowExamUserActivity.this, BorrowExamActivity.class, bundle);
            }
        });
    ...
    private void loadPeople(){
        if (!Redirect.checkNetwork(BorrowExamUserActivity.this)) {
            Toast toast = Toast.makeText(BorrowExamUserActivity.this,"网络未连接", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else{
            // 提示框
            dialog = new ProgressDialog(BorrowExamUserActivity.this);
            dialog.setTitle("提示");
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Fragment f = Fragment.instantiate(BorrowExamUserActivity.this, fragmentClass.getName());

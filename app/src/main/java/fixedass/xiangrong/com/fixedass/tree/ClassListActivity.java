...
//        btnBack.setImageResource(R.drawable.save);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Redirect.redirect(ClassListActivity.this, ListAddActivity.class, bundle);
            }
        });
    ...
    private void loadClass(){
        if (!Redirect.checkNetwork(ClassListActivity.this)) {
            Toast toast = Toast.makeText(ClassListActivity.this,"网络未连接", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else{
            // 提示框
            dialog = new ProgressDialog(ClassListActivity.this);
            dialog.setTitle("提示");
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Fragment f = Fragment.instantiate(ClassListActivity.this, fragmentClass.getName());

...
public class BorrowUpdUserFragment extends Fragment implements TreeNode.TreeNodeClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tView.setDefaultNodeClickListener(BorrowUpdUserFragment.this);
    ...
    private TreeNode addProfileData() {
        ...
        for (Dept d: twoDeptList){
            ...
            if (d.getDeptType().equals("0")){       //公司
                System.out.println("=====deptJstreeList====="+deptJstreeList+"====(deptJstreeList!=null)==="+(deptJstreeList!=null));
    ...
    public void onClick(TreeNode node, Object value) {
        if (value instanceof SocialViewHolder.SocialItem){
            ...
            Redirect.redirect(getActivity(), BorrowUpdActivity.class, bundle);

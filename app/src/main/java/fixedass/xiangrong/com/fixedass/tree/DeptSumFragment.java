 ...
 * @Describe 部门树结构设计
 */
public class DeptSumFragment extends Fragment implements TreeNode.TreeNodeClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tView.setDefaultNodeClickListener(DeptSumFragment.this);
    ...
    public void onClick(TreeNode node, Object value) {
        if (value instanceof SocialViewHolder.SocialItem){
            ...
            bundle.putString("useDept", item.text);
            bundle.putString("useDeptUUID", item.pUUID);
            Redirect.redirect(getActivity(), SumSelActivity.class, bundle);

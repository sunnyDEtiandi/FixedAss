...
//        btnBack.setImageResource(R.drawable.save);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Redirect.redirect(ClassActivity.this, LedgerSelActivity.class, bundle);
            }
        });
    ...
    private void loadClass(){
        if (!Redirect.checkNetwork(ClassActivity.this)) {
            Toast toast = Toast.makeText(ClassActivity.this,"网络未连接", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else{
            // 提示框
            dialog = new ProgressDialog(ClassActivity.this);
            dialog.setTitle("提示");
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Fragment f = Fragment.instantiate(ClassActivity.this, fragmentClass.getName());

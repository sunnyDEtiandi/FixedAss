...
import fixedass.xiangrong.com.fixedass.summary.LedgerSelActivity;
...
//        btnBack.setImageResource(R.drawable.change);
        btnQuit.setVisibility(View.GONE) ;     //表示隐藏

        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Redirect.redirect(DeptActivity.this, LedgerSelActivity.class, bundle);
            }
        });
    ...
    private void loadDept(){
        if (!Redirect.checkNetwork(DeptActivity.this)) {
            Toast toast = Toast.makeText(DeptActivity.this,"网络未连接", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else{
            // 提示框
            dialog = new ProgressDialog(DeptActivity.this);
            dialog.setTitle("提示");
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Fragment f = Fragment.instantiate(DeptActivity.this, fragmentClass.getName());

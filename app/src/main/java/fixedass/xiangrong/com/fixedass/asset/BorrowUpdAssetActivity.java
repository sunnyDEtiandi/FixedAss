...
import fixedass.xiangrong.com.fixedass.manage.BorrowUpdActivity;
...
/*添加资产的资产详情*/
public class BorrowUpdAssetActivity extends Activity implements View.OnClickListener{
    /*标题栏*/
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        /*读取数据*/
        SharedPreferences sharedPreferences = BorrowUpdAssetActivity.super.getSharedPreferences("ipConfig", Activity.MODE_PRIVATE);
    ...
    private void getAddAss(){
        if (!Redirect.checkNetwork(BorrowUpdAssetActivity.this)) {
            Toast toast = Toast.makeText(BorrowUpdAssetActivity.this,"网络未连接", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else{
            // 提示框
            dialog = new ProgressDialog(BorrowUpdAssetActivity.this);
            dialog.setTitle("提示");
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        /*if (selStoList.size()<1){
                            selStoList = new ArrayList<>();
                        }*/
                        ArrayList selSto = new ArrayList<>();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnBack:
                Redirect.redirect(BorrowUpdAssetActivity.this, BorrowUpdActivity.class, bundle);
                break;
            case R.id.btnQuit:      //保存
                ...
                if(selStoList.size()==0){
                    Dialog dialog = new AlertDialog.Builder(BorrowUpdAssetActivity.this)
                            .setTitle("资产借还提示")
    ...
    View.OnKeyListener returnKey = new View.OnKeyListener() {
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_DOWN) {
                Redirect.hideIM(v,BorrowUpdAssetActivity.this);

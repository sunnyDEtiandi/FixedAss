...
public class BorrowExamUserFragment extends Fragment implements TreeNode.TreeNodeClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tView.setDefaultNodeClickListener(BorrowExamUserFragment.this);
    ...
    public void onClick(TreeNode node, Object value) {
        if (value instanceof SocialViewHolder.SocialItem){
            ...
            Redirect.redirect(getActivity(), BorrowExamActivity.class, bundle);
            //Toast toast = Toast.makeText(getActivity(), ((IconTreeItemHolder.IconTree Item)value).text, Toast.LENGTH_SHORT);
        }
    }
}

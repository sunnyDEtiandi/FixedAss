...
public class TransferUserActivity extends Activity{
    ...
    private void initView(){
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Redirect.redirect(TransferUserActivity.this, TransferAddActivity.class, bundle);
            }
        });
    ...
    private void loadPeople(){
        if (!Redirect.checkNetwork(TransferUserActivity.this)) {
            Toast toast = Toast.makeText(TransferUserActivity.this,"网络未连接", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else{
            // 提示框
            dialog = new ProgressDialog(TransferUserActivity.this);
            dialog.setTitle("提示");
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Fragment f = Fragment.instantiate(TransferUserActivity.this, fragmentClass.getName());

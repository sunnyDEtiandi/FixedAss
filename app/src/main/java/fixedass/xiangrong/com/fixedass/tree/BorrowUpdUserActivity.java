...
public class BorrowUpdUserActivity extends Activity{
...
//        btnBack.setImageResource(R.drawable.save);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Redirect.redirect(BorrowUpdUserActivity.this, BorrowUpdActivity.class, bundle);
            }
        });
    ...
    private void loadPeople(){
        if (!Redirect.checkNetwork(BorrowUpdUserActivity.this)) {
            Toast toast = Toast.makeText(BorrowUpdUserActivity.this,"网络未连接", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else{
            // 提示框
            dialog = new ProgressDialog(BorrowUpdUserActivity.this);
            dialog.setTitle("提示");
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Fragment f = Fragment.instantiate(BorrowUpdUserActivity.this, fragmentClass.getName());

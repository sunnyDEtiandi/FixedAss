...
//        btnBack.setImageResource(R.drawable.save);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Redirect.redirect(DeptListActivity.this, ListAddActivity.class, bundle);
            }
        });
    ...
    private void loadDept(){
        if (!Redirect.checkNetwork(DeptListActivity.this)) {
            Toast toast = Toast.makeText(DeptListActivity.this,"网络未连接", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else{
            // 提示框
            dialog = new ProgressDialog(DeptListActivity.this);
            dialog.setTitle("提示");
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Fragment f = Fragment.instantiate(DeptListActivity.this, fragmentClass.getName());

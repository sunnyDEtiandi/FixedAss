...
public class TestService {
    /*获得借还的所有数据--筛选*/
    public static String getTestSel(String ip, User user, String conSql){
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + ip + "/FixedAssService/test/getSel";
    ...
    public static String getOrderBy(String ip, User user, String conSql){
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + ip + "/FixedAssService/test/getOrder";
    ...
    public static String examineInfo(String ip,User user,String operbillCodes){
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + ip + "/FixedAssService/test/examineInfo";
    ...
    public static String exam(String ip,User user,String conSql){
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + ip + "/FixedAssService/test/examine";
    ...
    public static String lookThroughInfo(String ip,User user,String operbillCodes){
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + ip + "/FixedAssService/test/lookThroughInfo";
            path = path + "?userUUID=" + user.getUserUUID()+"&operbillCode="+operbillCodes;
    ...
    public static String lookThrough(String ip,User user,String conSql){
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + ip + "/FixedAssService/test/lookThrough";
            path = path + "?userUUID=" + user.getUserUUID()+"&"+conSql;
            Log.i("exam-ip",path);
    ...
    public static String confirmInfo(String ip,User user,String operbillCodes){
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + ip + "/FixedAssService/test/confirmInfo";
            path = path + "?userUUID=" + user.getUserUUID()+"&operbillCode="+operbillCodes;
    ...
    public static String confirm(String ip,User user,String conSql){
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + ip + "/FixedAssService/test/confirm";
            path = path + "?userUUID=" + user.getUserUUID()+"&"+conSql;
    ...
    public static String delete(String ip,User user,String operbillCodes){
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + ip + "/FixedAssService/test/delete";
            path = path + "?userUUID=" + user.getUserUUID()+"&operbillCode="+operbillCodes;
    ...
    public static String getCareMan(String ip,User user,String pUUID){
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + ip + "/FixedAssService/test/getCareMan";
    ...
    public static String getPlace(String ip,User user,String pUUID){
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + ip + "/FixedAssService/test/getPlace";
            path = path + "?sysUUID=" + user.getSysUUID()+"&pUUID="+pUUID;
    ...
    public static String add(String ip, User user, String conSql){
        // URL 地址
        String path = "http://" + ip + "/FixedAssService/test/add";
    ...
    public static String updateInfo(String path){
        HttpURLConnection conn = null;
        InputStream is = null;

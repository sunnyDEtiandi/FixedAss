...
public class BorrowUserFragment extends Fragment implements TreeNode.TreeNodeClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tView.setDefaultNodeClickListener(BorrowUserFragment.this);
    ...
    public void onClick(TreeNode node, Object value) {
        if (value instanceof SocialViewHolder.SocialItem){
            ...
            Redirect.redirect(getActivity(), BorrowAddActivity.class, bundle);

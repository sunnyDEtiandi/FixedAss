...
public class TransferUserFragment extends Fragment implements TreeNode.TreeNodeClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tView.setDefaultNodeClickListener(TransferUserFragment.this);
    ...
    public void onClick(TreeNode node, Object value) {
        if (value instanceof SocialViewHolder.SocialItem){
            ...
            Redirect.redirect(getActivity(), TransferAddActivity.class, bundle);

...
import fixedass.xiangrong.com.fixedass.manage.TransferAddActivity;
...
/*添加资产的资产详情*/
public class TransferAssetActivity extends Activity implements View.OnClickListener{
    /*标题栏*/
    ...
    private User user;
    /*private String pName,pUUID,borrowDate,borrowDays,borrowInfo,operNote;*/
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        /*读取数据*/
        SharedPreferences sharedPreferences = TransferAssetActivity.super.getSharedPreferences("ipConfig", Activity.MODE_PRIVATE);
        ...
        borrowDate = bundle.getString("borrowDate");
        borrowDays = bundle.getString("borrowDays");
        borrowInfo = bundle.getString("borrowInfo");
        operNote = bundle.getString("operNote");*/
    ...
    private void getAddAss(){
        if (!Redirect.checkNetwork(TransferAssetActivity.this)) {
            Toast toast = Toast.makeText(TransferAssetActivity.this,"网络未连接", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else{
            // 提示框
            dialog = new ProgressDialog(TransferAssetActivity.this);
            dialog.setTitle("提示");
    ...
    public void onClick(View v) {
        ...
        /*bundle.putString("pName", pName);
        bundle.putString("pUUID", pUUID);
        bundle.putString("borrowDate", borrowDat);
        bundle.putString("borrowDays", borrowDay);
        bundle.putString("borrowInfo", borrowInf);
        bundle.putString("operNote", operNot);*/
        switch (v.getId()) {
            case R.id.btnBack:
                Redirect.redirect(TransferAssetActivity.this, TransferAddActivity.class, bundle);
                break;
            case R.id.btnQuit:      //保存
                ...
                if(stoLists.size()==0){
                    Dialog dialog = new AlertDialog.Builder(TransferAssetActivity.this)
                            .setTitle("资产转移提示")
    ...
    View.OnKeyListener returnKey = new View.OnKeyListener() {
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_DOWN) {
                Redirect.hideIM(v,TransferAssetActivity.this);

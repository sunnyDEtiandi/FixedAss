...
public class BorrowUserActivity extends Activity{
...
//        btnBack.setImageResource(R.drawable.save);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Redirect.redirect(BorrowUserActivity.this, BorrowAddActivity.class, bundle);
            }
        });
    ...
    private void loadPeople(){
        if (!Redirect.checkNetwork(BorrowUserActivity.this)) {
            Toast toast = Toast.makeText(BorrowUserActivity.this,"网络未连接", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.CENTER, 0, 0);
            toast.show();
        }else{
            // 提示框
            dialog = new ProgressDialog(BorrowUserActivity.this);
            dialog.setTitle("提示");
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Fragment f = Fragment.instantiate(BorrowUserActivity.this, fragmentClass.getName());
